...
{:else}
  ...
  >
    ...
    <div
      class="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-gradient-to-br from-blue-200/40 to-indigo-200/40 blur-3xl"
    ></div>
    <div
    ...
    >
      ...
      <section class="text-center max-w-3xl mx-auto">
        ...
        >
          <span
            class="inline-flex h-5 w-5 items-center justify-center rounded-full bg-blue-600 text-white text-[10px]"
            >AI</span
          >
        ...
        >
          <a
            href="/signin"
            class="w-full sm:w-auto inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-7 py-3 rounded-lg shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600 cursor-pointer transition-colors"
            >Get Started</a
          >
          <a
            href="#features"
            class="w-full sm:w-auto inline-flex items-center justify-center bg-white/80 backdrop-blur text-blue-700 text-sm font-medium px-7 py-3 rounded-lg border border-blue-300 hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600 cursor-pointer transition-colors"
            >Learn More</a
          >
        </div>
      </section>
      ...
      <section class="mt-20">
        ...
        >
          <div class="flex items-center gap-2 text-slate-500 text-sm">
            <span
              class="h-2.5 w-2.5 rounded-full bg-gradient-to-br from-blue-500 to-blue-700"
      ...
      <section id="features" class="mt-24">
        <div class="grid md:grid-cols-3 gap-6">
          <Card variant="glass" padding="p-6" custom="flex flex-col">
            <div
              class="h-12 w-12 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center mb-4"
            >
              <svg
                class="w-6 h-6"
                fill="none"
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {#each [{ step: 1, title: "Set Up Project", copy: "Define your business profile (name, location, type)." }, { step: 2, title: "Add Queries", copy: "Pick or generate search phrases customers would use." }, { step: 3, title: "Run Analysis", copy: "RankLens queries each provider multiple times for statistical reliability." }, { step: 4, title: "Get Insights", copy: "See rankings, competitor visibility and improvement opportunities." }] as item}
              <div class="text-center">
                <div
                  class="mx-auto mb-4 h-10 w-10 flex items-center justify-center rounded-full bg-blue-600 text-white text-sm font-medium"
                >
                  {item.step}
                </div>
      ...
      <section class="mt-24">
        <div
          class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 p-10 text-center shadow-sm"
        >
          <div
          ...
          <p class="relative mt-3 text-sm text-blue-100 max-w-xl mx-auto">
